...
const CreateLeaveTypeSheet: React.FC<CreateLeaveTypeSheetProps> = ({ open, onOpenChange, defaultCompanyId }) => {
    ...
    const onSubmit = async (data: LeaveTypeFormValues) => {
        try {
            ...
            toast({
                title: t('leaveTypes.createdSuccessTitle'),
                description: t('leaveTypes.createdSuccessMsg'),
            });
            onOpenChange(false);
            form.reset();
        } catch (error: any) {
            ...
            toast({
                title: t('leaveTypes.createError'),
            ...
            >
                <SheetHeader className="flex flex-row items-center justify-between">
                    <SheetTitle className="text-2xl font-bold text-foreground">
                        {t('leaveTypes.addLeaveTypeTitle')}
                    </SheetTitle>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <FormSelect
                                            ...
                                            options={[
                                                { label: t('leaveTypes.status.active'), value: 'Active' },
                                                { label: t('leaveTypes.status.inactive'), value: 'Inactive' }
                                            ]}
                                            t={t}
                                        />
                                        ...
                                        <FormSelect
                                            ...
                                            options={[
                                                { label: t('leaveTypes.condition.paid'), value: 'Paid' },
                                                { label: t('leaveTypes.condition.unpaid'), value: 'Unpaid' }
                                            ]}
                                            t={t}
                                        />
                                    </div>
...
export default CreateLeaveTypeSheet;
