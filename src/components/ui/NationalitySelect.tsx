...
export function NationalitySelect<T extends FieldValues>({ control, name, label, placeholder, error, t, disabled, id }: Props<T>) {
          ...
          <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-[--radix-popover-trigger-width] p-0" align="start">
              <Command>
                ...
                <CommandList>
                  <CommandEmpty>{t("errors.noResults") || "No nationality found."}</CommandEmpty>
                  <CommandGroup>
                    {nationalities.map((n) => (
                      <CommandItem
                        key={n.value}
