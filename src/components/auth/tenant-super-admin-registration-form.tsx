...
} from '@/features/auth/schemas/tenant-registration-schema';
...
export function TenantSuperAdminRegistrationForm({
    invitationToken,
    initialEmail = '',
    initialFirstName = '',
    initialLastName = '',
    tenantName,
    title,
}: TenantSuperAdminRegistrationFormProps) {
    ...
    }, [initialEmail, initialFirstName, initialLastName, reset]);
    ...
    const onSubmit = async (data: TenantRegistrationFormValues) => {
        ...
        try {
            ...
            setServerError(t('errorSubmitting', { defaultValue: 'Something went wrong. Please try again.' }));
        }
    };

    const isRTL = i18n.language === 'ar';
    const displayTenantName = tenantName || t('tenantFallback', { defaultValue: 'Your tenant' });
                    ...
                    <div className="flex items-center gap-3 w-full max-w-50">
                        ...
                        <div className="space-y-0.5">
                            <p className="text-sm font-normal opacity-80 leading-none">
                                {t('tenant', { defaultValue: 'Tenant' })}
                            </p>
                            <p className="text-[17px] font-medium leading-tight">{displayTenantName}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 w-full max-w-50">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <p className="text-[17px] font-medium leading-tight">
                                {t('systemAdmin', { defaultValue: 'HRMS admin' })}
                            </p>
                        </div>
                    </div>
                </div>
