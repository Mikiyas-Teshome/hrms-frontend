  ...
  return (
      <div className="flex flex-col items-center justify-center p-4">
          <Card className="w-full max-w-md overflow-hidden border-border bg-background shadow-sm ring-1 ring-border sm:rounded-xl">
              <CardHeader className="space-y-1 py-6 text-center px-3 sm:px-6 sm:text-start">
              ...
              <CardContent className="space-y-8 px-3 pb-12 text-foreground sm:px-6 rtl:text-end">
                  <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                          ...
                          <p className="text-xs text-muted-foreground rtl:text-end">{t('hint')}</p>
                      </div>
                      ...
                      <div className="text-center text-sm text-muted-foreground">
                          ...
                          <button
                              ...
                              className="font-medium cursor-pointer text-primary hover:underline disabled:opacity-50 disabled:no-underline"
                          >
